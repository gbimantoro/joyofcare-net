...
poe.HANDLERS['antar-jemput-rumah-sakit-jakarta-harga-biaya-dan-perbandingan.txt'] = (h_antar_jemput_biaya_perbandingan, 'articles-new')
poe.HANDLERS['antar-jemput-rumah-sakit-jakarta-harga-panduan-lengkap.txt'] = (h_antar_jemput_panduan_lengkap, 'articles-new')
poe.HANDLERS['dokter-umum-ke-rumah-tangerang-biaya-dan-perbandingan.txt'] = (h_dokter_tangerang_biaya_perbandingan, 'articles-new')
poe.HANDLERS['dokter-umum-ke-rumah-tangerang-panduan-lengkap.txt'] = (h_dokter_tangerang_panduan_lengkap, 'articles-new')
poe.HANDLERS['kesehatan-lansia-sehat-rutinitas-harian-biaya-dan-perbandingan.txt'] = (h_kesehatan_lansia_rutinitas_biaya_perbandingan, 'articles-new')
poe.HANDLERS['latihan-fisioterapi-untuk-lansia-di-rumah-biaya-dan-perbandingan.txt'] = (h_latihan_fisioterapi_biaya_perbandingan, 'articles-new')
poe.HANDLERS['osteoporosis-pada-lansia-pencegahan-dan-perawatan-biaya-dan-perbandingan.txt'] = (h_osteoporosis_biaya_perbandingan, 'articles-new')
poe.HANDLERS['panggil-dokter-ke-rumah-jakarta-biaya-dan-perbandingan.txt'] = (h_panggil_dokter_jakarta_biaya_perbandingan, 'articles-new')
poe.HANDLERS['perawat-lansia-di-rumah-jabodetabek-panduan-lengkap.txt'] = (h_perawat_lansia_panduan_lengkap, 'articles-new')
poe.HANDLERS['vaksin-di-rumah-jakarta-lansia-biaya-dan-perbandingan.txt'] = (h_vaksin_lansia_biaya_perbandingan, 'articles-new')
poe.HANDLERS['vaksin-di-rumah-jakarta-lansia-panduan-lengkap.txt'] = (h_vaksin_lansia_panduan_lengkap, 'articles-new')

price_regex = re.compile(r'Rp[\s\.]*\d+')
currency_regex = re.compile(r'(?:USD|AUD|GBP|EUR|$|\£)\s*[\d\.,]+')
